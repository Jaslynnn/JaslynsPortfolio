                ...
                createPortal(
                    ...
                    >
                        <motion.div
                            ...
                            className={cn(
                                "relative isolate flex flex-col w-full my-4 max-h-[85vh] max-w-screen-2xl bg-[#0b0b0e] border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden"
                            )}
                        >
                            {/* Header */}
                            {modalTitle && (
                            ...
                            {/* Footer */}
                            <footer className="border-t border-white/[0.08] px-6 py-4 flex justify-end">
                                <button
                                    onClick={closeModal}
