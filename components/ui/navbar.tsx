  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "flex relative flex-col lg:hidden w-full justify-between items-center max-w-[calc(100vw-2rem)] mx-auto z-50 backdrop-saturate-[1.8] border border-solid border-white/10 rounded-full"
        )}
      >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="flex rounded-3xl absolute top-16 bg-Black/90 backdrop-blur-sm backdrop-saturate-[1.8] inset-x-0 z-50 flex-col items-start justify-start gap-4 w-full px-6 py-8"
            >
              {navItems.map(
